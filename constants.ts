...
export const THEMES = {
  ...
  random: [] // Handled logically
};

// Pentatonic scale frequencies (C Major Pentatonic)
// Added lower octave (C3) for richer, less piercing sound
// C3, D3, E3, G3, A3, C4, D4...
...
export const INITIAL_SETTINGS = {
  gravity: 500, // Slightly reduced for floatier controls
  friction: 0.9995, // Near-zero air resistance to maintain momentum
  restitution: 0.85, // High default bounciness
  timeScale: 1.0,
  ballCount: 1,
  trailLength: 20,
  autoSpawn: false,
